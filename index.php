...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="images/logo/motorcycle.png" alt="Yamaha">
            </a>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">Pilih Motor Terbaikmu di Sini</h1>
                    <p class="lead mb-4">Temukan motor terbaru dengan teknologi terdepan dan desain yang memukau. Wujudkan perjalanan impian Anda bersama Yamaha.</p>
    ...
    <section id="motors" class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Daftar Motor</h2>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p><i class="fas fa-envelope text-primary"></i> info@motor-shop.co.id</p>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>Motor Shop Indonesia</h5>
                    <p>Dealer resmi Motor Shop dengan layanan terbaik dan produk berkualitas tinggi.</p>
                </div>
                <div class="col-md-4">
                    <h5>Kontak</h5>
                    <p><i class="fab fa-whatsapp"></i> +62 821-2866-8284</p>
                    <p><i class="fas fa-phone"></i> (021) 1234-5678</p>
                    <p><i class="fas fa-envelope"></i> info@motor-shop.co.id</p>
                </div>
                <div class="col-md-4">
                    <h5>Ikuti Kami</h5>
            ...
            <div class="text-center">
                <p>&copy; 2025 Motor Shop Indonesia. All rights reserved.</p>
            </div>
        </div>
    </footer>
